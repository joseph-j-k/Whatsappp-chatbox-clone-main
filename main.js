$(function () {
  ...
  function send() {
    ...
    isInArray(hello, lastmsg) == true
      ...
      ? ((smsg = "I am Sorted Coding"), (k = smsg))
      ...
      ? ((smsg =
          "Thanks for checking my social media platforms.If you loved my content I kindly request you to like, subscribe & follow our social platforms @JosephFrancis "),
        (k = smsg),
        setTimeout(function () {
          $(".status").html("last seen today at " + time);
        }, 6000),
      ...
      : ((smsg =
          "Sorry, I didn't understand, please explain it with proper spellings or  If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search JosephFrancis</b>"),
        (k =
          "Sorry, I didn't understand, please explain it, with proper spellings, or  If you say, so I can search for you. To search,type,Search Your keyword,for example, type, Search JosephFrancis "));
    para = $(
